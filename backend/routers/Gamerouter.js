...
router.post('/checkout/:iduser', ProductController.checkoutCart)
router.put('/uploadTrans/:iduser', ProductController.postTransaction)
...
router.get('/gettotalharga/:id', ProductController.getTotalHarga)
